...
this.config = {
  customArguments: {
    ...
    description: "Specify your preferred arguments for `coffee`, supports [replacement](https://github.com/noseglid/atom-build#replacement) placeholders",
    type: "string",
    "default": "--compile",
    order: 0
  }
...
export function provideBuilder() {
  return class CoffeeProvider extends EventEmitter {
    ...
    isEligible() {
      try {
        stdout = execSync('coffee --version');
